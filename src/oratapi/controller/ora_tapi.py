...
from oratapi.lib.config_mgr import ConfigManager, load_config
from oratapi.lib.session_manager import DBSession, try_init_thick_mode
...
def print_runtime_initialisation_message() -> None:
    ...
    if not configured_profile:
        ...
        if profiles:
            ...
            print("  profile_mgr -a <profile-name>")
            print("\nIf you are running from a source checkout or extracted legacy install,")
            print("you can use the wrapper scripts in bin/ instead.")
        else:
            ...
            print("  quick_config -t <template-category>")
            print("\nIf you are running from a source checkout or extracted legacy install,")
            print("you can use the wrapper scripts in bin/ instead.")
    ...
    print("\nPlease run the following command to initialise the runtime files:")
    print("  quick_config -t <template-category>")
    print("\nIf you are running from a source checkout or extracted legacy install,")
    print("you can use the wrapper scripts in bin/ instead.")
    print("\nValid template categories: basic, liquibase, logger, llogger")
    ...
    def __init__(self, trace: bool = False):
        ...
        try:
            ...
            print(
                ...
                f"optional arguments.\n\nReplace <ora_tapi> with the installed console script `ora_tapi`."
                f"\nIf you are running from a source checkout or extracted legacy install, use the wrapper script "
                f"for your platform instead.\n"
                f"\nUse -h for help."
            )
