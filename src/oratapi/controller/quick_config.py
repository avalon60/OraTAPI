...
from oratapi.lib.fsutils import profile_home, resolve_default_path, runtime_home, write_active_profile
...
def copy_files(profile_name: str, template_category: str, force: bool, templates_only: bool=False) -> None:
    ...
    csv_sample = resolve_default_path(Path("resources") / "config" / "pi_columns.csv.sample")
